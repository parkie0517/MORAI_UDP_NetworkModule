...
# Network settings
control_IP = '143.248.50.159'    # 리눅스 서버 IP
sim_IP = '143.248.54.66'         # 윈도우 시뮬레이터 IP
EGO_PORT = 4121                  # Publisher, Subscriber, Service --> Ego Vehicle Status --> Destination PORT
CONTROL_PORT = 4110              # Cmd Control --> Ego Ctrl Cmd --> Host PORT
